...
# Tahap berikutnya adalah menyiapkan DataFrame yang akan digunakan untuk membuat visualisasi data.
# Untuk melakukan hal ini, kita perlu membuat beberapa helper function seperti berikut.
...
## kita akan menggunakan widget date input sebagai filternya dan akan ditempatkan pada bagian sidebar. 
## Selain itu, untuk alasan estetika, kita juga perlu menambahkan logo perusahaan ke dalam sidebar tersebut. 
...
## Nah, start_date dan end_date di atas akan digunakan untuk memfilter all_df. 
## Data yang telah difilter ini selanjutnya akan disimpan dalam main_df. Proses ini dijalankan menggunakan kode berikut.
...
## Pada proyek ini, kita akan menampilkan tiga informasi terkait daily orders, yaitu jumlah order harian serta total order dan revenue dalam range waktu tertentu.
## Pada contoh proyek ini, kita menampilkan informasi total order dan revenue dalam bentuk metric() yang ditampilkan menggunakan layout columns(). 
...
## Selain informasi terkait daily orders, kita juga perlu menyertakan informasi tentang performa penjualan dari setiap produk.
...
## Pada materi Latihan Membuat Visualisasi Data, kita telah membuat tiga buah visualisasi data untuk menjelaskan hal tersebut.
...
## Nah, pada proyek ini, kita akan menampilkan nilai average atau rata-rata dari ketiga parameter tersebut menggunakan widget metric().
